...
func newLoggedValue(for value: some Any) -> LoggedValue {
...
public func traceAsNecessary(_ value: some Any, file: StaticString, line: Int, column: UInt, function: StaticString, moduleReference: SourceLocation.ModuleReference) {
